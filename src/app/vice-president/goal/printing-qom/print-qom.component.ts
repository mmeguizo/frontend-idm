...
// printPdf() {
//   let print = document.getElementById('printQom')?.innerHTML;
//   let win = window.open('', '_blank', 'top=0,left=0,height=100%,width=auto');
...
//       .nested-table2 th:nth-child(1) {
//         background-color: darkred !important;
//         color: white !important;
//       }

//       .nested-table2 th:nth-child(2) {
//         background-color: darkblue !important;
//         color: white !important;
//       }

//       .nested-table2 th:not(:nth-child(1)):not(:nth-child(2)) {
...
//               <div>
//                 <div>Prepared by:</div>
//                 <div>${this.preparedByValue.toUpperCase()}</div>
//                 <div>${this.preparedByofficeValue.toUpperCase()}</div>
//               </div>
//               <div>
//                 <div>Counter Checked by:</div>
//                 <div>${this.counterCheckedValue.toUpperCase()}</div>
//                 <div>${this.counterCheckedofficeValue.toUpperCase()}</div>
//               </div>
//               <div>
//                 <div>Reviewed by:</div>
//                 <div>${this.reviewedByValue.toUpperCase()}</div>
//                 <div>${this.reviewedByofficeValue.toUpperCase()}</div>
//               </div>
//             </div>
//           </td>
//         </tr>
...
//           </tr>
//            </thead>
//                  <body onload="window.close()">${print}</body>
//                  <tbody class="data-cells">
//           <tr>
//             <td></td>
//             <td></td>
